...
class RegisterLayout extends Component {
  componentDidMount() {
    ...
    function onPasswordFocus(e) {
      activeElement = "password" || "repeatPassword";
      if (!eyesCovered) {
        coverEyes();
      }
    }
    ...
    function onRepeatPasswordToggleBlur(e) {
      activeElement = null;
      if (!showPasswordClicked) {
        setTimeout(function () {
          if (
    ...
    function onRepeatPasswordToggleChange(e) {
      setTimeout(function () {
        // if checkbox is checked, show password
        if (e.target.checked) {
          password.type = "text";
    ...
    function initLoginForm() {
      ...
      repeatPassword.addEventListener("focus", onPasswordFocus);
      repeatPassword.addEventListener("blur", onPasswordBlur);
      ...
      //   showRepeatPasswordCheck.addEventListener("change", onPasswordToggleChange);
      ...
      <div className="App">
        <form>
          ...
          <div className="inputGroup inputGroup1">
            <label for="loginEmail" id="EmailLabel">
              Tên đăng nhập
            </label>
